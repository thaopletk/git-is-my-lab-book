...
1. For absolute beginners:
    ...
    - A list of useful packages, especially for infectious disease modelling;
    - A list of commonly used code editors;
    - Tutorials and learning resources (e.g. for Python and R);
2. For organising your project:
...
3. For reproducibility (this entire guide!)
    ...
    - How to make your code device-agnostic, so it can run on HPC platforms, virtual machines, and can easily be migrated to new devices
4. Extra/help
    - How to recover [old versions of files](../guides/using-git/inspecting-your-history.md);
    - How to speed up code or run time
    - How to produce good (?) figures
    - Workflow guide (e.g., start with a virtual environment, then organise your files, write code, write testing code, set up continuous integration...)
